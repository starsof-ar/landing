  ...
  <Grid>
        ...
        <Accordion defaultValue={true} title="MODAL">
          ...
          <Card title="EXAMPLE">
            ...
            <ModalTrigger modal={ModalError} modalProps={{ message: <>Non-fatal error detected: error FOOLISH (Please contact STARSOF support.)</>, title: `SETUP` }}>
